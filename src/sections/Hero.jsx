...
const Hero = () => {
  const [bigShoeImg, setBigShoeImg] = useState(john);
  ...
  return (
    ...
    >
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full  max-xl:padding-x pt-28">
        <h1 className="mt-10 font-palanquin text-[70px] max-sm:text-[72px] max-sm:leading-[82px] font-bold">
        ...
        <p className="font-montserrat text-slate-gray text-lg leading-8 mt-6 mb-8 sm:max-w-sm">
          Discover all the Game of Thrones characters in one place.
        </p>
        <p className="text-xl font-montserrat text-coral-red mb-8">
          Download Now
        </p>

        <div className="flex">
          <div className="w-[370px]">
            <img src={playstore} alt="Play Store" className="h-auto" />
          </div>
        </div>
